...
def parse_args():
    ...
    Скрипт для предсказания модели
     ...
     Примеры:
        ...
        2) без poetry - python3 predict.py --test_data /Users/a19028558/Desktop/Ralf_Hack/train.csv --model_path /path/to/model --output /Users/a19028558/Desktop/Ralf_Hack/output_file.csv.gzip
    """,
